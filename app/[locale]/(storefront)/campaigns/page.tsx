...
export async function generateMetadata(
  ...
  const [tNav, tCampaigns] = await Promise.all([
    getTranslations({ locale, namespace: 'nav' }),
    getTranslations({ locale, namespace: 'campaigns' }),
  ]);
  return {
    title: tNav('campaigns') || 'Campaigns',
    description: tCampaigns('meta_description'),
  };
}
