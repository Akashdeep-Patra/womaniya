    ...
    <section className="px-4 sm:px-6 py-12 md:py-16 max-w-3xl mx-auto text-center">
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-bengal-kajal text-bengal-kori font-semibold text-sm tracking-wide hover:bg-bengal-kajal/90 transition-all duration-300 shadow-xl shadow-black/10 hover:shadow-2xl hover:-translate-y-0.5"
        >
