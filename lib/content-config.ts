...
export const contentNamespaces: ContentNamespaceConfig[] = [
  {
    name: 'nav',
    label: 'Navigation',
    description: 'Header and menu links',
    keys: [
      { key: 'home', label: 'Home' },
      { key: 'shop', label: 'Shop' },
  ...
  },
  {
    ...
    description: 'The Womaniya Way — 4 feature cards',
    keys: [
  ...
  },
  {
    name: 'shop',
    label: 'Shop Section',
    description: 'Product grid section on homepage',
    keys: [
      { key: 'title', label: 'Section Title' },
  ...
  },
  {
    name: 'product',
    label: 'Product Page',
    description: 'Product detail page labels',
    keys: [
  ...
  },
  {
    name: 'about',
    label: 'About Section',
    description: 'About Womaniya section',
    keys: [
  ...
  {
    name: 'glimpses',
    label: 'Glimpses Section',
    description: 'From Loom to Wardrobe gallery',
    keys: [
      { key: 'badge', label: 'Section Badge' },
      { key: 'title', label: 'Section Title' },
      { key: 'subtitle', label: 'Section Subtitle', multiline: true },
  ...
  },
  {
    ...
    description: 'How We Craft — step-by-step journey',
    keys: [
      { key: 'badge', label: 'Section Badge' },
      { key: 'title', label: 'Section Title' },
      { key: 'subtitle', label: 'Section Subtitle', multiline: true },
  ...
  },
  {
    ...
    description: 'Philosophy statement',
    keys: [
  ...
  {
    name: 'voices',
    label: 'Voices Section',
    description: 'Testimonials / Voices of the Craft',
    keys: [
      { key: 'title', label: 'Section Title' },
      { key: 'subtitle', label: 'Section Subtitle', multiline: true },
